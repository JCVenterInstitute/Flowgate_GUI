 ...
 * fcsService.groovy
 * ---
 * Contains the code to read fcs files.
 * Based on the code by Jonathan Irish.
 *
 * Contains code from Cytobank (TM)
 *
 ...
 * be subclassed and is highly file-dependent, respectively.
 */
...
//    public int analysisStart = 0;
    Integer analysisStart = 0
//    public int analysisEnd = 0;
    Integer analysisEnd = 0
//    public int supplementalStart = 0;
    Integer supplementalStart = 0
//    public int supplementalEnd = 0;
    Integer supplementalEnd = 0
//    public char delimiter = '\\';		// TEXT segment delimiter character
    String delimiter = "\\\\"		// TEXT segment delimiter character
//    public String text = null;		// The entire TEXT segment
    String text = null		// The entire TEXT segment
...
//    private Properties settings = null;
    ...
    Boolean littleEndianP

    Integer parameters = 0
    String sampleName = null
    String dataType = null
    String cytometer = null
    String mode = null
    ...
    String creatorSoftware = null
    String cytometerNumber = null
    String experimentDate = null
    String experimentName = null
    String exportTime = null
    String exportUser = null
    String GUID = null
    String windowExtension = null
    String threshold = null
    String tubeName = null
    String spillString = null
    Boolean applyCompensation = false

    String source = null
    String nextData = null
    String endsText = null
    String bTime = null
    ...
    Integer lasers = 0
    String[] laserASF = null
    String[] laserName = null
    String[] laserDelay = null

    String[] channelName = null
    String[] channelShortname = null
    String[] channelGain = null
    Integer[] channelBits = null
    String[] channelAmp = null
    Double[] channelRange = null
    String[] channelVoltage = null
    Boolean[] displayLog = null
    Double[] ampValue = null
     ...
     */
    def fcsFile(String path) throws FileNotFoundException, IOException {
        fcsFile(path, EXTRACTP)
    }
     ...
     * @throws <code>java.io.IOException</code> if an IO exception occurred.
     */
    def fcsFile(File file) throws FileNotFoundException, IOException {
        fcsFile(file, EXTRACTP)
    }
     ...
     * @throws <code>java.io.IOException</code> if an IO exception occurred.
     */
    def fcsFile(String path, boolean extractEventsP) throws FileNotFoundException, IOException {
        // Create a file using the path and use the other constructor that takes a File.
        fcsFile(new File(path), extractEventsP)
    }
    ...
    def fcsFile(File file, boolean extractEventsP) throws FileNotFoundException, IOException {
        this.file = file
     ...
     * @throws <code>java.io.IOException</code> if an IO exception occurred.
     */
    def readFile(File fcsfile, boolean extractEventsP) throws FileNotFoundException, IOException {
        ...
        byte[] headerArray = new byte[HEADER_SIZE]
        ...
        String text = decoder.decode(mbb.slice()).toString()
...
//          pairs = text.split("[" + Character.toString(delimiter) + "]")
            pairs = text.split("[${delimiter.toString()}]")
        }
         ...
         */
        Integer numPairs = (pairs.length - 1) / 2
        ...
        def i = 1
//        TODO store parameters in fileMetadata
        /**
         * Extract Events
         */
     ...
     * parseSettings
     * ---
     * Uses all the properties in Properties settings to initialize the fields of fcsFile.>
     *
     * I pulled it out since it involves a lot of constants and I don't want
     * to mix it with the file reading and parsing code.
     */
    def parseSettings() {
        if (settings == null) {
        ...
        channelBits = new Integer[parameters]
...
//            TODO check for naming!!! PnN -- channelShortname vs channelName
...
//            simplified
        ...
        if(numBitsPerEvent > 0) {
            ...
            Integer calculatedNumEvents = (dataEnd - dataStart + 1) * 8 / numBitsPerEvent
     ...
     * @throws <code>java.io.IOException</code> if an IO exception occurred.
     */
    def extractEvents() throws FileNotFoundException, IOException {
...
//    private void readBinIntData(ByteBuffer data) {
    def readBinIntData(ByteBuffer data) {
     ...
     * @param data <code>ByteBuffer</code> containing the DATA segment of the underlying file.
     */
    def readFloatData(ByteBuffer data) {
        // Allocate the eventList
        eventList = new int[totalEvents][parameters]
     ...
     * @param data <code>ByteBuffer</code> containing the DATA segment of the underlying file.
     */
    def readDoubleData(ByteBuffer data) {
        // Allocate the eventList
        eventList = new int[totalEvents][parameters]
     ...
     * @param data <code>ByteBuffer</code> containing the DATA segment of the underlying file.
     */
    def readASCIIData(ByteBuffer data) {
        /**
...
//    private int getChannelHelper(boolean sideScatterP) {
    /* int getChannelHelper(boolean sideScatterP) {
...
//    public boolean isLog(int channelNumber) {
    /*boolean isLog(int channelNumber) {
...
//    public boolean getIsLog(int channelNumber) {
    /*boolean getIsLog(int channelNumber) {
        return isLog(channelNumber)
    }
*/
    /*******************************************************************************************************************/
...
//    public boolean isDisplayLog(int channelNumber) {
    /*boolean isDisplayLog(int channelNumber) {
...
//    public boolean getDisplayLog(int channelNumber) {
    /*boolean getDisplayLog(int channelNumber) {
...
//    public double getAmpValue(int channelNumber) {
    /*double getAmpValue(int channelNumber) {
...
//    public double getChannelRange(int channelNumber) {
    /*double getChannelRange(int channelNumber) {
...
//    public double getScaleRange(int channelNumber) {
    /*double getScaleRange(int channelNumber) {
...
//    public boolean getAmpDisplay(int channelNumber) {
    /*boolean getAmpDisplay(int channelNumber) {
...
//            return false
//        }
        return (!getIsLog(channelNumber) && getDisplayLog(channelNumber))
        }
    }
*/
    /*******************************************************************************************************************/
...
//    public static boolean isFCSFile(File file) throws FileNotFoundException, IOException {
    /* boolean isFCSFile(File file) throws FileNotFoundException, IOException {
...
//    def printFCSFile(fcsFile f) {
    /*def printFCSFile(def f) {
