...
//  def testUser = User.findOrSaveByUsernameAndPasswordAndEmailAndAffiliation( 'acs', 'acs', 'peter.acs@stanford.edu', 'som')
  ...
  def alphaTester4 = User.findOrSaveByUsernameAndPasswordAndEmailAndAffiliation('alpha4', 'flowGate', 'alpha4@flowgate.ui', 'jcvi')
  def alphaTester5 = User.findOrSaveByUsernameAndPasswordAndEmailAndAffiliation('alpha5', 'flowGate', 'alpha5@flowgate.ui', 'jcvi')
...
//  def exp3 = new Experiment(title: 'exp3', description: 'exp3 desc', project: proj2, isActive: true).save(failOnError: true)
  ...
  def rP = new ReagentPanel(reagentPanelName: 'combo', reagents: []).save()
  def ch1 = new Reagent ( reagentPanel: rP, channel: 'FL1-A', fluorochrome: 'VioBlue-A',                 marker: 'CD16', transformName: '-', inputMin: 0, inputMax: 0, outputMin: 0, outputMax: 0)
  ch1.save()
  def ch2 = new Reagent ( reagentPanel: rP, channel: 'FL2-A', fluorochrome: 'FITC-A',                    marker: 'GR', transformName: '-', inputMin: 0, inputMax: 0, outputMin: 0, outputMax: 0).save()
  def ch3 = new Reagent ( reagentPanel: rP, channel: 'FL3-A', fluorochrome: 'PE-A',                      marker: 'not used', transformName: '-', inputMin: 0, inputMax: 0, outputMin: 0, outputMax: 0).save()
  def ch4 = new Reagent ( reagentPanel: rP, channel: 'FL4-A', fluorochrome: 'PI/PE-Cy5.5-A/PEcy5/PerCP', marker: 'CD14', transformName: '-', inputMin: 0, inputMax: 0, outputMin: 0, outputMax: 0).save()
  def ch5 = new Reagent ( reagentPanel: rP, channel: 'FL5-A', fluorochrome: 'PE-Cy7-A',                  marker: 'not used', transformName: '-', inputMin: 0, inputMax: 0, outputMin: 0, outputMax: 0).save()
  def ch6 = new Reagent ( reagentPanel: rP, channel: 'FL6-A', fluorochrome: 'APC-A',                     marker: 'CD3', transformName: '-', inputMin: 0, inputMax: 0, outputMin: 0, outputMax: 0).save()
  def ch7 = new Reagent ( reagentPanel: rP, channel: 'FL7-A', fluorochrome: 'APC-Cy7-A',                 marker: 'not used', transformName: '-', inputMin: 0, inputMax: 0, outputMin: 0, outputMax: 0).save()
  rP.reagents = [ch1, ch2, ch3, ch4, ch5, ch6, ch7]
  rP.save()

  def expFile1012 = new ExpFile(experiment: exp1, title: '1012_Combo.fcs', chkSum: 'abc', fileName: '1012_Combo.fcs', filePath: '/Users/acs/Projects/flowgate/testData/ds1_combo/', createdBy: adminUser, isActive: true, reagentPanel: rP).save(failOnError: true)
  def expFile1013 = new ExpFile(experiment: exp1, title: '1013_Combo.fcs', chkSum: 'abc', fileName: '1013_Combo.fcs', filePath: '/Users/acs/Projects/flowgate/testData/ds1_combo/', createdBy: adminUser, isActive: true, reagentPanel: rP).save(failOnError: true)
  def expFile1014 = new ExpFile(experiment: exp1, title: '1014_Combo.fcs', chkSum: 'abc', fileName: '1014_Combo.fcs', filePath: '/Users/acs/Projects/flowgate/testData/ds1_combo/', createdBy: adminUser, isActive: true, reagentPanel: rP).save(failOnError: true)
  def expFile1015 = new ExpFile(experiment: exp1, title: '1015_Combo.fcs', chkSum: 'abc', fileName: '1015_Combo.fcs', filePath: '/Users/acs/Projects/flowgate/testData/ds1_combo/', createdBy: adminUser, isActive: true, reagentPanel: rP).save(failOnError: true)
  def expFile1016 = new ExpFile(experiment: exp1, title: '1016_Combo.fcs', chkSum: 'abc', fileName: '1016_Combo.fcs', filePath: '/Users/acs/Projects/flowgate/testData/ds1_combo/', createdBy: adminUser, isActive: true, reagentPanel: rP).save(failOnError: true)
  def expFile1017 = new ExpFile(experiment: exp1, title: '1017_Combo.fcs', chkSum: 'abc', fileName: '1017_Combo.fcs', filePath: '/Users/acs/Projects/flowgate/testData/ds1_combo/', createdBy: adminUser, isActive: true, reagentPanel: rP).save(failOnError: true)
  def expFile1018 = new ExpFile(experiment: exp1, title: '1018_Combo.fcs', chkSum: 'abc', fileName: '1018_Combo.fcs', filePath: '/Users/acs/Projects/flowgate/testData/ds1_combo/', createdBy: adminUser, isActive: true, reagentPanel: rP).save(failOnError: true)
  def expFile1019 = new ExpFile(experiment: exp1, title: '1019_Combo.fcs', chkSum: 'abc', fileName: '1019_Combo.fcs', filePath: '/Users/acs/Projects/flowgate/testData/ds1_combo/', createdBy: adminUser, isActive: true, reagentPanel: rP).save(failOnError: true)
  def expFile1020 = new ExpFile(experiment: exp1, title: '1020_Combo.fcs', chkSum: 'abc', fileName: '1020_Combo.fcs', filePath: '/Users/acs/Projects/flowgate/testData/ds1_combo/', createdBy: adminUser, isActive: true, reagentPanel: rP).save(failOnError: true)
  def expFile1021 = new ExpFile(experiment: exp1, title: '1021_Combo.fcs', chkSum: 'abc', fileName: '1021_Combo.fcs', filePath: '/Users/acs/Projects/flowgate/testData/ds1_combo/', createdBy: adminUser, isActive: true, reagentPanel: rP).save(failOnError: true)
  def expFile1022 = new ExpFile(experiment: exp1, title: '1022_Combo.fcs', chkSum: 'abc', fileName: '1022_Combo.fcs', filePath: '/Users/acs/Projects/flowgate/testData/ds1_combo/', createdBy: adminUser, isActive: true, reagentPanel: rP).save(failOnError: true)
  def expFile1023 = new ExpFile(experiment: exp1, title: '1023_Combo.fcs', chkSum: 'abc', fileName: '1023_Combo.fcs', filePath: '/Users/acs/Projects/flowgate/testData/ds1_combo/', createdBy: adminUser, isActive: true, reagentPanel: rP).save(failOnError: true)
  def expFile1024 = new ExpFile(experiment: exp1, title: '1024_Combo.fcs', chkSum: 'abc', fileName: '1024_Combo.fcs', filePath: '/Users/acs/Projects/flowgate/testData/ds1_combo/', createdBy: adminUser, isActive: true, reagentPanel: rP).save(failOnError: true)
  def expFile1025 = new ExpFile(experiment: exp1, title: '1025_Combo.fcs', chkSum: 'abc', fileName: '1025_Combo.fcs', filePath: '/Users/acs/Projects/flowgate/testData/ds1_combo/', createdBy: adminUser, isActive: true, reagentPanel: rP).save(failOnError: true)
  def expFile1029 = new ExpFile(experiment: exp1, title: '1029_Combo.fcs', chkSum: 'abc', fileName: '1029_Combo.fcs', filePath: '/Users/acs/Projects/flowgate/testData/ds1_combo/', createdBy: adminUser, isActive: true, reagentPanel: rP).save(failOnError: true)
  def expFile1030 = new ExpFile(experiment: exp1, title: '1030_Combo.fcs', chkSum: 'abc', fileName: '1030_Combo.fcs', filePath: '/Users/acs/Projects/flowgate/testData/ds1_combo/', createdBy: adminUser, isActive: true, reagentPanel: rP).save(failOnError: true)
  def expFile1031 = new ExpFile(experiment: exp1, title: '1031_Combo.fcs', chkSum: 'abc', fileName: '1031_Combo.fcs', filePath: '/Users/acs/Projects/flowgate/testData/ds1_combo/', createdBy: adminUser, isActive: true, reagentPanel: rP).save(failOnError: true)
  def expFile1032 = new ExpFile(experiment: exp1, title: '1032_Combo.fcs', chkSum: 'abc', fileName: '1032_Combo.fcs', filePath: '/Users/acs/Projects/flowgate/testData/ds1_combo/', createdBy: adminUser, isActive: true, reagentPanel: rP).save(failOnError: true)
  def expFile1033 = new ExpFile(experiment: exp1, title: '1033_Combo.fcs', chkSum: 'abc', fileName: '1033_Combo.fcs', filePath: '/Users/acs/Projects/flowgate/testData/ds1_combo/', createdBy: adminUser, isActive: true, reagentPanel: rP).save(failOnError: true)
  def expFile1035 = new ExpFile(experiment: exp1, title: '1035_Combo.fcs', chkSum: 'abc', fileName: '1035_Combo.fcs', filePath: '/Users/acs/Projects/flowgate/testData/ds1_combo/', createdBy: adminUser, isActive: true, reagentPanel: rP).save(failOnError: true)
  def expFile1036 = new ExpFile(experiment: exp1, title: '1036_Combo.fcs', chkSum: 'abc', fileName: '1036_Combo.fcs', filePath: '/Users/acs/Projects/flowgate/testData/ds1_combo/', createdBy: adminUser, isActive: true, reagentPanel: rP).save(failOnError: true)
  def expFile1037 = new ExpFile(experiment: exp1, title: '1037_Combo.fcs', chkSum: 'abc', fileName: '1037_Combo.fcs', filePath: '/Users/acs/Projects/flowgate/testData/ds1_combo/', createdBy: adminUser, isActive: true, reagentPanel: rP).save(failOnError: true)
  def expFile1038 = new ExpFile(experiment: exp1, title: '1038_Combo.fcs', chkSum: 'abc', fileName: '1038_Combo.fcs', filePath: '/Users/acs/Projects/flowgate/testData/ds1_combo/', createdBy: adminUser, isActive: true, reagentPanel: rP).save(failOnError: true)
...
//            new MetadataVoc(mdKey: '', mdVal: '', category: '', dispOrder: 0, status: 'active').save()
    ...
    def fillExperimentMetadata(Experiment exp){
            ...
            new ExperimentMetadata(experiment: exp, mdKey: 'SubjectID', mdVals: [], mdCategory: 'Demographics', dispOrder: 02, expFiles: [], visible: true).save()
            new ExperimentMetadata(experiment: exp, mdKey: 'Age', mdVals: [], mdCategory: 'Demographics', dispOrder: 100, expFiles: [], visible: true).save()
            new ExperimentMetadata(experiment: exp, mdKey: 'Gender', mdVals: [mdValGenF,mdValGenM], mdCategory: 'Demographics', dispOrder: 04, expFiles: [], visible: true).save()
            new ExperimentMetadata(experiment: exp, mdKey: 'Ethnicity', mdVals: [mdValEthn1], mdCategory: 'Demographics', dispOrder: 20, expFiles: [], visible: true).save()
            new ExperimentMetadata(experiment: exp, mdKey: 'Race', mdVals: [mdValRace1,mdValRace2,mdValRace3], mdCategory: 'Demographics', dispOrder: 40, expFiles: [], visible: true).save()
            new ExperimentMetadata(experiment: exp, mdKey: 'Fluorochrome', mdVals: [mdValReag1,mdValReag2,mdValReag3,mdValReag4,mdValReag5,mdValReag6,mdValReag7], mdCategory: 'Reagents', dispOrder: 1, dispOnFilter: false, expFiles: [], visible: true).save()
            def em1 = new ExperimentMetadata(experiment: exp, mdKey: 'Marker', mdVals: [mdValMarker1,mdValMarker2,mdValMarker3,mdValMarker4,mdValMarker3,mdValMarker6,mdValMarker3], mdCategory: 'Reagents', dispOrder: 2, dispOnFilter: false, expFiles: [], visible: true).save()
            new ExperimentMetadata(experiment: exp, mdKey: 'Channel', mdVals: [mdValChanFl1A,mdValChanFl2A,mdValChanFl3A,mdValChanFl4A,mdValChanFl5A,mdValChanFl6A,mdValChanFl7A], mdCategory: 'Reagents', dispOrder: 0, dispOnFilter: false, expFiles: [], visible: true).save()
