...
<html>
    ...
    <div class="nav" role="navigation">
        ...
        <div id="create-analysis" class="content scaffold-create" role="main">
            <h2 class="text-center"><g:message code="analysis.create.label" default="Add New Analysis" /></h2>
            <br />
            ...
            <g:form controller="analysis" action="save" enctype="multipart/form-data">
                ...
                <div class="panel with-nav-tabs panel-default" >
                    ...
                    <fieldset class="text-center">
                        ...
                        <g:submitButton name="create" class="save btn btn-success" value="${message(code: 'analysis.create.btn.label', default: 'Run/Submit')}" />
                        <div class="btn btn-danger"><i class="fa fa-times">&nbsp;Cancel</i></div>
                        %{--</div>--}%
                    </fieldset>
                    <br />
