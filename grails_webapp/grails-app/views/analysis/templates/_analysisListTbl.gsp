<table class="table table-bordered table-responsive table-striped table-hover dataTable" width="100%">
  <thead>
  <tr>
    <g:sortableColumn class="text-center" property="analysisName" title="${message(code: 'propTitle.analysisName.column', default: 'Analysis Name')}"/>
    <g:sortableColumn class="text-center" property="analysisStatus" title="${message(code: 'propTitle.analysisStatus.column', default: 'Analysis Status')}"/>
    <g:sortableColumn class="text-center" property="timestamp" title="${message(code: 'propTitle.timestamp.column', default: 'Sent')}"/>
    <g:sortableColumn class="text-center" property="user" title="${message(code: 'propTitle.User.column', default: 'User')}"/>
