...
<body>
<a href="#show-analysisPipelineElement" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="show-analysisPipelineElement" class="content scaffold-show" role="main">
  ...
  <g:form resource="${this.analysisPipelineElement}" method="DELETE">
    <fieldset class="buttons">
      <g:link class="edit" action="edit" resource="${this.analysisPipelineElement}"><g:message
